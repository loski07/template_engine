...
class VariableManager:
    ...
    In the real world I would have adapted the variable file to look like a JSON file (adding `{}` and `,`) and read
    it as JSON, but the requirements are not using external libraries.
    """
